...
import { encryp, decryp, encryptBase64, genIv, decryptBase } from '../inc/cryp.js';
    ...
    <Card containerStyle={{ backgroundColor: "transparent", elevation: 0, shadowOpacity: 0, borderWidth:'none' }}>
     ...
     >
       <View style={styles.entry}>
         <Card.Title style={styles.job}>{entry.job}</Card.Title>
         <Card.Divider />
